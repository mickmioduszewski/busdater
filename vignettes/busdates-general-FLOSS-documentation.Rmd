...
* Style will be checked with https://cran.r-project.org/web/packages/lintr/index.html, which in turn follows [Hadley Wickham's R Style Guide](http://r-pkgs.had.co.nz/style.html).
...
* Developers will have Developer Certificate of Origin
